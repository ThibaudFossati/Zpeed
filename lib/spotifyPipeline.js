...
function metaForRoom(session) {
  ...
  return {
    ...
    magicInviteSuggestions: Array.isArray(session.magicInviteSuggestions) ? session.magicInviteSuggestions : [],
    hostProfileUserId: typeof session.hostTasteUserId === 'string' && session.hostTasteUserId ? session.hostTasteUserId : null
  };
}
